...
# Добавляем переменные, которые запрашивает bot.py
CASE_COST = 2500  
ADMIN_ID = 5056869104      # Сюда можно будет вписать твой ID из Telegram
SKINS = {}        # Пустой список скинов, чтобы не было ошибки
